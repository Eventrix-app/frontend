...
//   EXPO_PUBLIC_APPLE_CLIENT_ID   (Apple Services ID, e.g. com.eventrix.app.signin)
//   EXPO_PUBLIC_APPLE_REDIRECT_URI (must match what you register at developer.apple.com)
// ---------------------------------------------------------------------------
...
// Apple's web OAuth discovery — works on every platform (Android, iOS, web)
const APPLE_DISCOVERY = { authorizationEndpoint: 'https://appleid.apple.com/auth/authorize' };
...
export const SocialLoginRow: React.FC<SocialLoginRowProps> = ({ compact = false, appleIconVariant = 'default' }) => {
  ...
  // Apple web OAuth — works on all platforms via appleid.apple.com
