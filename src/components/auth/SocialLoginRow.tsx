...
const FACEBOOK_DISCOVERY = { authorizationEndpoint: 'https://www.facebook.com/v18.0/dialog/oauth' };
...
export const SocialLoginRow: React.FC<SocialLoginRowProps> = ({ compact = false, appleIconVariant = 'default' }) => {
  ...
  // Facebook — only public_profile, no email scope to avoid App Review requirement
