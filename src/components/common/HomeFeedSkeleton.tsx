...
const styles = StyleSheet.create({
  // Must match HomeScreen's featuredWrap negative margins, which cancel the ScrollView's
  // padding. Without them a white band appears between header and feed while loading.
  featuredWrap: {
